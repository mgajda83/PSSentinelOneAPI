#
# Module manifest for module 'PSSentinelOneAPI'
#
...
RootModule = 'PSSentinelOneAPI.psm1'
...
PrivateData = @{
	...
	PSData = @{
		...
		LicenseUri = 'https://github.com/mgajda83/PSSentinelOneAPI/blob/main/LICENSE'

		# A URL to the main website for this project.
		ProjectUri = 'https://github.com/mgajda83/PSSentinelOneAPI'
